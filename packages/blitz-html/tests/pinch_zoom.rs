//! Pinch-to-zoom (`zoom_by_factor_at`) must apply the zoom factor multiplicatively,
//! clamp the resulting zoom level, and adjust the viewport scroll so that the
//! content under the anchor point remains stationary.
