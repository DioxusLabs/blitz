...
use self::gradient::GradientFiller;
use self::image::ImageFiller;
use self::rounded_blurred_rect::BlurredRoundedRectFiller;
use super::util::scalar::div_255;
use crate::vello_common::encode::{EncodedKind, EncodedPaint};
use crate::vello_common::paint::Paint;
use crate::vello_common::peniko::{BlendMode, Compose, Mix};
use crate::vello_common::{
    coarse::{Cmd, WideTile},
    tile::Tile,
};
use alloc::vec;
...
pub(crate) mod fill {
    ...
    use super::super::fine::{COLOR_COMPONENTS, TILE_HEIGHT_COMPONENTS, blend};
    use super::super::util::scalar::div_255;
    use crate::vello_common::peniko::{BlendMode, Compose, Mix};
...
pub(crate) mod strip {
    ...
    use super::super::util::scalar::div_255;
    use crate::vello_common::peniko::{BlendMode, Compose, Mix};
    use crate::vello_common::tile::Tile;
