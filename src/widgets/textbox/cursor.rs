    ...
    pub fn handle_input(
        ...
        match data.key_code {
                    ...
                    self.move_cursor(
                        |c| {
                            ...
                            while row + change + 1 < length {
                                let chr = text.lines().nth(row + change).unwrap_or_default();
                                if chr.chars().all(|chr| chr.is_whitespace()) {
                                    break;
                                }
                                change += 1;
            ...
            Backspace => {
                ...
                let start_idx = self.start.idx(text);
                if self.end.is_some() {
            ...
            Enter => {
                let old_col = self.start.col(text);
            ...
            Tab => {
                self.start.realize_col(text);
                let mut change = self.delete_selection(text);
                text.insert(self.start.idx(text), '\t');
...
fn cursor_input() {
    ...
    for _ in 0..5 {
        cursor.handle_input(
            &dioxus::events::KeyboardData {
                char_code: 0,
                key: "".to_string(),
                key_code: dioxus::events::KeyCode::RightArrow,
                alt_key: false,
                ctrl_key: false,
                meta_key: false,
                shift_key: false,
    ...
    for _ in 0..5 {
        cursor.handle_input(
            &dioxus::events::KeyboardData {
                char_code: 0,
                key: "".to_string(),
                key_code: dioxus::events::KeyCode::Backspace,
                alt_key: false,
                ctrl_key: false,
                meta_key: false,
                shift_key: false,
    ...
    cursor.handle_input(
        &dioxus::events::KeyboardData {
            char_code: 'h'.into(),
            key: 'h'.to_string(),
            key_code: dioxus::events::KeyCode::H,
            alt_key: false,
            ctrl_key: false,
            meta_key: false,
            shift_key: false,
    ...
    cursor.handle_input(
        &dioxus::events::KeyboardData {
            char_code: 'e'.into(),
            key: 'e'.to_string(),
            key_code: dioxus::events::KeyCode::E,
            alt_key: false,
            ctrl_key: false,
            meta_key: false,
            shift_key: false,
    ...
    cursor.handle_input(
        &dioxus::events::KeyboardData {
            char_code: 'l'.into(),
            key: 'l'.to_string(),
            key_code: dioxus::events::KeyCode::L,
            alt_key: false,
            ctrl_key: false,
            meta_key: false,
            shift_key: false,
    ...
    cursor.handle_input(
        &dioxus::events::KeyboardData {
            char_code: 'o'.into(),
            key: 'o'.to_string(),
            key_code: dioxus::events::KeyCode::O,
            alt_key: false,
            ctrl_key: false,
            meta_key: false,
            shift_key: false,
